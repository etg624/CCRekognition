                      ...
                      case "AMAG":
                           //###### Thu Dec 19 05:55:01 PDT 2017 Call New module to pad one of the credenital fields in the AMAG export
                            padZerosToAMAG.padAndRewrite(csvFileName, function(err, res2){ 
                              ...
                              console.log ("csvFileNameAmended is "+csvFileNameAmended)
                              ...
                              strSQL = strPrepend+"'"+csvFileNameAmended+"'"+" REPLACE INTO TABLE people FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '\"' LINES TERMINATED BY '\n' IGNORE 1 LINES (LastName, FirstName, @var1, @dummy, @dummy, @var2, @dummy, @dummy, @dummy, @dummy,@dummy, @dummy, @dummy, @dummy,@dummy, @dummy, @dummy, @dummy,@dummy, @dummy,@dummy, @dummy, @dummy,@dummy, @dummy, @dummy, @dummy, imageName ) SET iClassNumber = CONCAT(@var2, @var1), EmpID = CONCAT(@var2, @var1), updateTime ="+_updateTime;                 
