...
module.exports.relayAccessLevels = function(moduleCallback){
    ...
    var callback = function(response) {
        ...
        if (strJ.length > 0){
            ...
            console.log("after parse"+strJ[0].BadgeID)    
        ...
          } else {
                ...
                for (var i=0; i < strJ.length; i++) {
                    ...
                    var _badgeNumber = strJ[i].BadgeID
                    var _empID = strJ[i].EmpID
                    accessLevels.createAccessLevel(connection, _badgeNumber, _empID, function(err,rslt){
                        ...
                        if (counter == rowsToInsert){
                            ...
                            console.log("AL INSERTSUCCESSFUL "+(rowsToInsert+1))
