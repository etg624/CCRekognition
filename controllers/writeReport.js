                    ...
                    connection.query(_sqlQ1, function(err, results1) {
                      if(err) { console.log('people email query bad'+err);}
                          ...
                          for (i=0; i<results.length; i++) { 
                            ...
                            //###### Jun 11 2018 Sub-header based on type
                            if (i==0){
                                wstream.write(header);
                                wstream.write('\n');
                                ...
                                if (type=="Mustering"){
                                  ...
                                  wstream.write("Attendance Count: "+results.length); 
                                }   
                           ...
                           function endReportProcessing(){
                              ...
                              fs.close(fd, function(err){         
                                if (err){            
                                  ...
                                  //###### Sun Jun 10 13:33:47 PDT 2018 Distinguish the caller types
                                  //###### Sun Jun 11 13:33:47 PDT 2018 Send the eventID back

                                  if (caller == "screen"){
                                    callback(sess.rptError, sess.rptSuccess, title);
                                  }else{
                                    callback(null,  'Report has been generated', title, eventID);
