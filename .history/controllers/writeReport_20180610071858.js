      ...
      db.createConnection(function(err,reslt){  
          if (err) {
            ...
            if (report == 'Attendance') {
              ...
              module.exports.writeActivityReport (report, connection, eventID, itemTempID, function(err,reslt, fileName){  
            ...
            if (report == 'Mustering') {
              ...
              module.exports.writeActivityReport (report, connection, musterID, itemTempID, function(err,reslt, fileName){  
                callback(sess.rptError, sess.rptSuccess, fileName);
                //return;
...
module.exports.writeActivityReport = function(type, connection, eventID, eventTempID, callback) {
