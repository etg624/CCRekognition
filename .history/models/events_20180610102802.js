...
exports.getAllEventsEndedSinceLastSweep = function(connection, data, callback) {
  
  currentDateTime = datetime.syncCurrentDateTimeforDB()
  var strSQL = "Select * from events where EventDate <= "+currentDateTime+" AND EventEndProcessed !='YES'"
  //
